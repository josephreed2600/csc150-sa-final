...
public class RuleList extends ArrayList<IRule> implements IRule {
  ...
  /**
   * Returns a string containing the stringified forms of the contained rules, separated by the
   * ASCII unit separator (31), terminated by the ASCII record separator (30).
   */
  @Override
